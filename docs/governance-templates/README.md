...
| [`15_GIT_POLICY.md`](15_GIT_POLICY.md) | Git Policy | Phase-start git baseline checks, branch strategy, commit conventions, push policy, temporary hiding for migration and scoped deletion rules. |
