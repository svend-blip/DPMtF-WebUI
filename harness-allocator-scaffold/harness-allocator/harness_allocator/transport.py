...
reproduced multiple times. This module defines a length-delimited frame so that
ONE complete semantic task maps to EXACTLY ONE frame, regardless of how many
newlines the payload contains.
