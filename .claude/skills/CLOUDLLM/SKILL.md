...
heading. It read `/CLOUDLLM` until 2026-08-12, which no client has ever
offered.
...
sqlite3 -readonly databases/dpmtf.db "SELECT role_key, allocator_client, \
  fresh_session_command FROM bridge_roles WHERE role_key IN ('archi01cloud','imple01cloud','review01cloud','review02cloud')"
```
