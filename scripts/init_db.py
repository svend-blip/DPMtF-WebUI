...
endpoint_registry_2i_v2 = [
    ...
    ("ENDP-4000044", "prompt_compiler_dispatch", "/api/prompt-compiler/dispatch", "POST",
     "Run BridgeV002 dispatcher (signal-send) from a UI button, eliminating manual terminal invocation of dispatch.py",
     "dispatch result JSON with success flag and output", "template_manager"),
] 
...
cursor.executemany(
    ...
    [
        ...
        ("strict_review", "imple01-review01", "imple01", "review01",
         "/home/svend/flows/strict_review/results", "{ID}-result.md", None, "post-dispatch-common",
