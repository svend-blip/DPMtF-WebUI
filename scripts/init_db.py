...
phase_data = [
    ...
    ("1N", "System Setup Drawer Shell", "Add system setup drawer", "next", 13),
    ("1O", "Database-driven Frontend Layout Schema", "Create database-driven layout schema", "planned", 14),
    ("1P", "Database-driven Frontend Layout Renderer", "Render database-driven layout", "planned", 15),
