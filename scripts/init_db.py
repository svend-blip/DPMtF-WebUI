...
_bridge_setup_labels = [
    ("LBL-1000228", "lbl_bridge_panel_title", "bridge_setup", "Bridge Setup", "Panel heading for Bridge Setup"),
    ("LBL-1000229", "lbl_bridge_status_available", "bridge_setup", "Bridge configuration available", "Status: bridge tables exist"),
    ("LBL-1000230", "lbl_bridge_roles_title", "bridge_setup", "Roles", "Roles section title"),
    ("LBL-1000231", "lbl_bridge_role_add", "bridge_setup", "Add Role", "Add role button"),
    ("LBL-1000232", "lbl_bridge_role_key", "bridge_setup", "Role Key", "Role key field label"),
    ("LBL-1000233", "lbl_bridge_tmux_session", "bridge_setup", "Tmux Session", "Tmux session field label"),
    ("LBL-1000234", "lbl_bridge_start_cmd", "bridge_setup", "Start Command", "Start command field label"),
    ("LBL-1000235", "lbl_bridge_model_type", "bridge_setup", "Model Type", "Model type field label"),
    ("LBL-1000236", "lbl_bridge_cloud_model", "bridge_setup", "Cloud Model", "Cloud model field label"),
    ("LBL-1000237", "lbl_bridge_ollama_model", "bridge_setup", "Ollama Model", "Ollama model field label"),
    ("LBL-1000238", "lbl_bridge_setup_script", "bridge_setup", "Setup Script", "Setup script field label"),
    ("LBL-1000239", "lbl_bridge_teardown_script", "bridge_setup", "Teardown Script", "Teardown script field label"),
    ("LBL-1000240", "lbl_bridge_deliver_error_msg", "bridge_setup", "Error Message", "Error message field label"),
    ("LBL-1000241", "lbl_bridge_flows_title", "bridge_setup", "Flows", "Flows section title"),
    ("LBL-1000242", "lbl_bridge_flow_add", "bridge_setup", "Add Flow", "Add flow button"),
    ("LBL-1000243", "lbl_bridge_flow_key", "bridge_setup", "Flow Key", "Flow key field label"),
    ("LBL-1000244", "lbl_bridge_flow_name", "bridge_setup", "Name", "Flow name field label"),
    ("LBL-1000245", "lbl_bridge_flow_description", "bridge_setup", "Description", "Flow description field label"),
    ("LBL-1000246", "lbl_bridge_flow_step_order", "bridge_setup", "Step Order", "Flow step order label"),
    ("LBL-1000247", "lbl_bridge_flow_is_default", "bridge_setup", "Default", "Flow default flag label"),
    ("LBL-1000248", "lbl_bridge_steps_title", "bridge_setup", "Steps", "Steps section title"),
    ("LBL-1000249", "lbl_bridge_step_from_role", "bridge_setup", "From Role", "Step from role label"),
    ("LBL-1000250", "lbl_bridge_step_to_role", "bridge_setup", "To Role", "Step to role label"),
    ("LBL-1000251", "lbl_bridge_step_key", "bridge_setup", "Step Key", "Step key field label"),
    ("LBL-1000252", "lbl_bridge_deliverable_dir", "bridge_setup", "Deliverable Directory", "Deliverable directory label"),
    ("LBL-1000253", "lbl_bridge_deliverable_pattern", "bridge_setup", "Deliverable Pattern", "Deliverable pattern label"),
    ("LBL-1000254", "lbl_bridge_pre_dispatch_script", "bridge_setup", "Pre-Dispatch Script", "Pre-dispatch script label"),
    ("LBL-1000255", "lbl_bridge_post_dispatch_script", "bridge_setup", "Post-Dispatch Script", "Post-dispatch script label"),
    ("LBL-1000256", "lbl_bridge_step_sort_order", "bridge_setup", "Sort Order", "Step sort order label"),
    ("LBL-1000257", "lbl_bridge_step_add", "bridge_setup", "Add Step", "Add step button"),
    ("LBL-1000258", "lbl_bridge_step_remove", "bridge_setup", "Remove Step", "Remove step button"),
    ("LBL-1000259", "lbl_bridge_edit", "bridge_setup", "Edit", "Edit button"),
    ("LBL-1000260", "lbl_bridge_delete", "bridge_setup", "Delete", "Delete button"),
    ("LBL-1000261", "lbl_bridge_save", "bridge_setup", "Save", "Save button"),
    ("LBL-1000262", "lbl_bridge_cancel", "bridge_setup", "Cancel", "Cancel button"),
    ("LBL-1000263", "lbl_bridge_active", "bridge_setup", "Active", "Active status label"),
    ("LBL-1000264", "lbl_bridge_inactive", "bridge_setup", "Inactive", "Inactive status label"),
    ("LBL-1000265", "lbl_bridge_created", "bridge_setup", "Successfully created", "Success message: created"),
    ("LBL-1000266", "lbl_bridge_updated", "bridge_setup", "Successfully updated", "Success message: updated"),
    ("LBL-1000267", "lbl_bridge_deleted", "bridge_setup", "Successfully deleted", "Success message: deleted"),
    ("LBL-1000268", "lbl_bridge_export", "bridge_setup", "Export", "Export button"),
    ("LBL-1000269", "lbl_bridge_export_all", "bridge_setup", "Export All", "Export all button"),
    ("LBL-1000270", "lbl_bridge_export_roles", "bridge_setup", "Export Roles", "Export roles button"),
    ("LBL-1000271", "lbl_bridge_export_flows", "bridge_setup", "Export Flows", "Export flows button"),
    ("LBL-1000272", "lbl_bridge_ollama_option", "bridge_setup", "Ollama", "Ollama option label"),
    ("LBL-1000273", "lbl_bridge_cloud_option", "bridge_setup", "Cloud", "Cloud option label"),
    ("LBL-1000274", "lbl_bridge_no_roles", "bridge_setup", "No roles configured", "Empty state: no roles"),
    ("LBL-1000275", "lbl_bridge_no_flows", "bridge_setup", "No flows configured", "Empty state: no flows"),
]
